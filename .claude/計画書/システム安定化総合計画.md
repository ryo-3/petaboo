...
- [ ] 既存コード置き換え（2/30箇所完了 - use-board-operations, use-simple-item-save）
- [ ] テスト・検証
- [ ] 完了
...
**フェーズ2進行中 - originalId統一完了、TeamContext移行中**（最終更新: 2025-10-10）
...
- 🔄 フェーズ2-2: チーム/個人判定一元化（2/30箇所完了）

### 次のステップ

- 🎯 TeamContext置き換え: 残り28箇所のteamMode判定をuseTeamContext()に移行
