...
export function TeamCreateInline({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const validationErrors = {
      ...
      adminDisplayName: validateField("adminDisplayName", adminDisplayName),
      customUrl: validateField("customUrl", customUrl),
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 flex-1 h-full">
        {/* 左側: メインフォーム */}
            ...
            >
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="このチームの目的や役割を説明してください"
                  rows={3}
        ...
        <div className="lg:col-span-2 flex flex-col h-full">
          <Card className="p-5 shadow-sm flex-1 flex flex-col bg-gradient-to-b from-slate-50 to-white h-full">
            {/* プラン情報セクション */}
            {teamStats && (
              <div className="mb-6">
