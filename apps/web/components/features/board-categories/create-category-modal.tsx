...
export default function CreateCategoryModal({
  ...
  const [editingCategory, setEditingCategory] = useState<BoardCategory | null>(
    null,
  );
      ...
      >
        ...
        <div className="flex-1 px-4 pb-4 overflow-hidden">
          <form onSubmit={handleSubmit} className="h-full flex flex-col">
            {/* 新規カテゴリー作成 */}
            <div className="flex-shrink-0 mb-4 pt-1">
              <div className="flex gap-2">
                <div className="flex-1 relative">
                  ...
                  />
                  <div
                    className={`absolute right-3 top-1/2 transform -translate-y-1/2 text-xs ${formData.name.length > 50 || isDuplicate ? "text-red-500" : "text-gray-500"}`}
                  >
