...
CREATE TABLE `__new_user_preferences` (
	...
	`created_at` real DEFAULT 1756466676375 NOT NULL,
	`updated_at` real DEFAULT 1756466676375 NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE `teams` ADD `custom_url` text NOT NULL;--> statement-breakpoint
CREATE UNIQUE INDEX `teams_custom_url_unique` ON `teams` (`custom_url`);