...
const TextInputWithCounter = forwardRef<HTMLInputElement, TextInputWithCounterProps>(
  ({ value, onChange, placeholder, maxLength, label, required = false, className = "", id }, ref) => {
