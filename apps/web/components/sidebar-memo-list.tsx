...
function SidebarMemoList({ onSelectMemo, onEditMemo }: SidebarMemoListProps) {
  ...
  return (
    <ul className="space-y-1">
      {notes.map((memo: Memo) => (
        <li key={memo.id}>
          <div className="flex items-start p-2 rounded hover:bg-gray-100 transition-colors group">
